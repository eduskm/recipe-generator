    ...
    return (
      <div className="relative w-full max-w-md mx-auto mt-2 ">
        <Input
          ...
          className="p-3 rounded-xl shadow-md white-placeholder"
        />
